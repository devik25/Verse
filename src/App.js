...
play_pause = async ()=>{
  ...
  render() {
    ...
    return (
      ...
      <Routes>
        <Route path='/search' element={<Searchbar_dark song={this.state.searched} update_song={this.update_song}/>}/>
        <Route path='/' element={<Searchbar_light song={this.state.searched} update_song={this.update_song}/> }/>
      </Routes>
